...
(function($, undefined) {
	$.fn.zyUpload = function(options, param) {
		...
		return this.each(function() {
					...
					this.addEvent = function() {
						if ($(".filePicker").length > 0) {
							$(".filePicker").bind("click", function(e) {
								container = $(this).prev().attr('data-id');
								$("#fileImage").click()
							})
						}
						...
						$(".upload_btn").bind("click", function(e) {
							    ...
							    objaccount="";
								    ...
								    allinputlist="";
								    var ywhdname=" ";
								     var tagElements = document.getElementsByName("attrib"+$("#activeId").val());
									   for(i=0;i<tagElements.length;i++){
									   if (tagElements[i].value==""){
	   		ywhdname=" ";
	   		var str = tagElements[i].value;
	  			var regu = "^[ ]+$";
	   		...
	   		ywhdname=tagElements[i].value;
	   		
	   	}
										   allinputlist += ywhdname + ",";
									   }
								    if (flag){
										 flag=false;
									$.ajax({
													...
													$.ajax({
														...
														success : function(data) {
															if (data.errcode > 0 && data.errmsg != 'ok') {
																...
																alert("温馨提示：请选择对应的问题内审核处理，提交成功后专员将在10分钟之内为您处理，请过15分钟后用“审核进度查询”功能，查询专员给您回复的信息，谢谢！");
