$(function() {
	...
	//采种列表动画
	/*$(".menuboxl").hover(function(){
		$(".dropr").css({"bacground-positionX":"-245px"});
		$(".lfetmenuhid").css({"display":"block"});
		$(".lfetmenuhid").stop().animate({height:"615px"},"200");
	},function(){
		$(".lfetmenuhid").stop().animate({height:"0px"},"200",function(){
...
function listData() {
	$.ajax({
		url: urlbublic + "lotteryBasePKS/getBasePKSList.do",
		type: "GET",
		data: {
			'lottObj': ""
		},
