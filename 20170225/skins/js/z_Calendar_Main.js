...
function drawCld(SY,SM) {
	...
	GZ.innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; <font color=#FFCC00>●</font>&nbsp;' + Animals[(SY2 - 4) % 12] + '年[农历' + cyclical(SY2 - 1900 + 36) + '年]' + '</a>&nbsp;<img src="img/' + ((SY2 - 4) % 12 + 1) + '.gif">&nbsp;';
	...
	for(i=0;i<42;i++) {
		...
		if(sD>-1 && sD<cld.length) { 
			sObj.innerHTML = sD+1;
			if(cld[sD].isToday) sObj.parentElement.parentElement.background = 'images/img_Calendar/img_Other/bk.gif'/*tpa=http://6hc.ph/views/caipiao/imgs/kjrq/js/images/img_Calendar/img_Other/bk.gif*/; 
